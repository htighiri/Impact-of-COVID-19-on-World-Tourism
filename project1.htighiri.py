...
# # World inbound toursits analysis
...
top_country_receipts = receipts_clean.sort_values("2020", ascending=False).head(10)
...
#find the top countries with the attract tourists most
top_country_export = percent_export_clean.sort_values("2020", ascending=False).head(10)
...
#find the top countries with the attract tourists most
top_country_outbound = outbound_tourists_clean.sort_values("2020", ascending=False).head(10)
...
trace1=go.Scatter(
    x=population_outbound("2020").index,
    y=population_outbound("2020").iloc[:,0],
    name="population")
#make the bar plot
trace2=go.Bar(
    x=population_outbound("2020").index,
    y=population_outbound("2020").iloc[:,1],
    name="tourists",
    yaxis="y2",
    #transparent level
    opacity=0.6,
